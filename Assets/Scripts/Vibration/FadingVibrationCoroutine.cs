...
public class FadingVibrationCoroutine : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Start the coroutine for fading vibration
        StartCoroutine(FadeVibration());
    }

    private IEnumerator FadeVibration()
    {
