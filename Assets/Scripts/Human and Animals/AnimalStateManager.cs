...
public class AnimalStateManager : Interactive
{
    ...
    private State ChangeState()
    {
        ...
        if (chance <= limit) return State.Sound;
    ...
    private IEnumerator SoundState()
    {
